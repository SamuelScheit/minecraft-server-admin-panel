...
<html>
  <head>
	...
	<style>
		div, html, body, head, h3, input, button, ul, .glyphicon, .glyphicon-console, .btn-group .btn-group-xs .pull-right, .btn btn-default, .hidden-xs, .form-control, .ui-autocomplete-input, .list-group-item{
    ...
    <div id="consoleRow">
      <div class="panel panel-default" id="consoleContent">
        <div class="panel-heading">
			<h3 class="panel-title pull-left"><span class="glyphicon glyphicon-console"></span><f class="css"> Console</f></h3>
